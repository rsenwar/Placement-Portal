   ...
   <li class="logo" style="margin:0;margin-bottom:-15px;">
    <a id="logo-container" href="./about.html" class="brand-logo" style="margin:0;">
     <img src="../images/pcell.png" alt="iiitg-pcell" style="height:55px;margin:0;">
            ...
            <li class="bold"><a href="students.php" class="collapsible-header  waves-effect waves-teal active">STUDENTS</a>
            </li>
            
            <li class="bold"><a href="print_list.php" class="waves-effect waves-teal">Print List</a></li>
			<li class="bold"><a href="company_info.php" class="waves-effect waves-teal">Company Info</a></li>
  ...
  <div class="row">
    ...
    <div class="col s12 m9 l10">
      ...
      <div id="home" class="section scrollspy">
        <form class="col s12" method="post" action='add_student.php'>
         <div class="row"><h3>ADD STUDENT: </h3></div>
         <div class="row">
          <div class="input-field col s4">
            <i class="material-icons prefix">grade</i>
            <input id="s_id" name = "s_id" type="text" class="validate" required>
          ...
          <div class='row'><div class="input-field col s4">
            <button type='submit' name='stu_add' class='col s12 btn waves-effect blue darken-4'>SUBMIT</button>
          </div>
        </form></div>
          ...
          ?>
        <div style="margin-right:auto;border:0px solid blue;padding:0px;">
 <h5>LIST OF STUDENTS: </h5></div>
<ul class="collection flow-text">
 <?php while($row = mysqli_fetch_array($result)) { ?>
    <li class="collection-item avatar">
      <i class="material-icons circle green">perm_identity</i>
      <span class="title">ID: </span>
      <p ><?php echo $row['s_id']; ?><br>
	<form method = "post" action = "stu_remove.php"><button type='submit' name="action" class='col s3 btn btn-large waves-effect blue darken-4' value="<?php   echo $row['s_id'];?>">REMOVE</button>
		</form>
      </p><br><br><br>
    </li>
     <?php } ?>
