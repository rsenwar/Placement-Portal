...
<i class="material-icons circle red">my_location</i>
	...
	<li class="collection-item avatar">
	<i class="material-icons circle yellow">perm_camera_mic</i>
	<span class="title">Update Palcement Status: </span>
	<p> 
	<form method = "post" action = "upd_status.php"><button type='submit' name="action" class='col s6 btn btn-large waves-effect blue darken-4' value="<?php   
                  echo $row['s_id'];?>">UPDATE STATUS</button>
		</form></p>
	</li>
  </ul>
          </div>
