...
<form class="col s12" method="post" action='upd_placement.php'>	
	<div class="row"> <h3>Update Status</h3></div>
	<div class="row">
      <div class="input-field col s6">
        <i class="material-icons prefix">account_circle</i>
        <input  id="st_time" name = "st_time" type="text" class="validate" required value="0" >
        <label for="st_time">Category 1</label>
      </div>
	<div class="input-field col s6">
        <i class="material-icons prefix">account_circle</i>
        <input  id="end_time" name = "end_time" type="text" class="validate" required value="0">
        <label for="end_time">Category 2</label>
      </div>
    </div>
<center>
              <div class='row'><div class="input-field col s6">
                <button type='submit' name='upd_status' class='col s12 btn btn-large waves-effect blue darken-4' value="<?php echo $s_id?>">Update Status</button></div></form>
