...
<form class="col s12" method="post" action='give_slot.php'>	
	<div class="row"> <h3>ASSIGN SLOT</h3></div>
	<div class="row">
      <div class="input-field col s6">
        <i class="material-icons prefix">account_circle</i>
        <input  id="st_time" name = "st_time" type="text" class="validate" required >
        <label for="st_time">START TIME</label>
      </div>
	<div class="input-field col s6">
        <i class="material-icons prefix">account_circle</i>
        <input  id="end_time" name = "end_time" type="text" class="validate" required >
    ...
    <div class="row">
      <div class="input-field col s6">
        ...
        <input id="room" name = "room" type="text" class="validate" data-length="7" required >
...
<center>
              <div class='row'><div class="input-field col s6">
                <button type='submit' name='give_slot' class='col s12 btn btn-large waves-effect blue darken-4' value="<?php echo $trr;?>">ASSIGN SLOT</button></div></form><form method="post" action='../includes/stu_logout.php'>
				</form>
