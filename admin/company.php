...
<form class="col s12" method="post" action='add_company.php'>
         <div class="row"><h3>ADD COMPANY: </h3></div>
         <div class="row">
          <div class="input-field col s4">
            <i class="material-icons prefix">grade</i>
            <input id="c_id" name = "c_id" type="text" class="validate" required>
            <label for="c_id">user id</label>
          </div>
          <div class="input-field col s4">
            <i class="material-icons prefix">grade</i>
            <input id="c_pass" name = "c_pass" type="text" class="validate" required>
            <label for="c_pass">Password</label>
          </div>


          <div class='row'><div class="input-field col s4">
            <button type='submit' name='comp_add' class='col s12 btn waves-effect blue darken-4'>SUBMIT</button>
          </div>
        </form></div>
...
<div class="row">
	...
	<div class = "col s6">
		...
		<?php 
			...
			$sql = "SELECT * FROM company,company_login where company_login.c_id=company.c_id";
			$result = mysqli_query($db, $sql);
		?>
	</div><div style="margin-right:500px;border:0px solid blue;padding:0px;">
<h5>LIST OF COMPANIES</h5></div>
<ul class="collection flow-text">
 <?php while($row = mysqli_fetch_array($result)) { ?>
	...
	<form method = "post" action = "comp_remove.php"><button type='submit' name="action" class='col s3 btn btn-large waves-effect blue darken-4' value="<?php   
                  echo $row['c_id'];?>">REMOVE</button>
		</form>
      </p><br><br><br>
    </li>
     <?php } ?>
