     ...
     <header>
      ...
      <ul id="nav-mobile" class="side-nav fixed">
          ...
          <li class="logo" style="margin:0;margin-bottom:-15px;">
			...
			<li class="bold"><a href="student_info.php" class="waves-effect waves-teal active">Student Info</a></li>
      ...
      <div id="home" class="section scrollspy">
        ...
        <div class="row">
         ...
         <div class = "col s6">
          ...
          <?php
			$sql = "SELECT s_id,f_name,l_name FROM student_info ";
...
<ul class="collection flow-text">
    ...
    <li class="collection-item avatar">
      ...
      <p><form method = "post" action = "stu_info.php"><button type='submit' name="action" class='col s11 btn btn-large waves-effect blue darken-4' value="<?php   
                  echo $row['s_id'];?>"><?php   
                  echo $row['f_name']." ".$row['l_name']." ID:".$row['s_id'];?></button>
		</form>
      </p>
    </li>
	<?php } ?>
