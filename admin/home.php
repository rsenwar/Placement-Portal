...
<h3> Welcome Admin </h3></center>
          <h5>Notifications: </h5>
 
<ul class="collection flow-text">
	<?php $sql="select * from applied";
    ...
    <li class="collection-item avatar">
      ...
      <p>
		...
		<?php $s_id=$row['s_id'];$sql1 = "select f_name from student_info where s_id='$s_id'";
			$result1 = mysqli_query($db, $sql1);
    $row1 = mysqli_fetch_array($result1);
		echo $row1['f_name']." Applied for ".$row['j_id'];?>
		<br><br><form method = "post" action = "assign_slot.php"><button type='submit' name="action" class='col s4 btn btn-large waves-effect blue darken-4' value="<?php   
                  echo $row['s_id'].".".$row['j_id'];?>">ASSIGN SLOT</button>
		</form>
