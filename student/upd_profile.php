...
<main>
	<div class="z-depth-2 s11" style="margin-left:25px;">
...
<div class='row'><div class="input-field col s6">
  <button type='submit' name='stu_update1' class='col s12 btn btn-large waves-effect blue darken-4'>UPDATE</button></div>
</form>
