  ...
  <form class="col s12" method="post" action='../includes/rec_update.php'>
    ...
    <center>
              <div class='row'><div class="input-field col s6">
                <button type='submit' name='rec_update' class='col s12 btn btn-large waves-effect blue darken-4'>SUBMIT</button></div></form><form method="post" action='../includes/rec_logout.php'>
				<div class="input-field col s6">
