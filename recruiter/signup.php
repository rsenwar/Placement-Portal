...
<body style="margin:auto;max-width:1000px;">
  ...
  <div class="row">
    <center>
    <h2> Recruiter Sign Up </h2></center>
    </div>
<div class="row">
  <form class="col s12" method="post" action='../includes/rec_update.php'>
    ...
    <div class="row">
      <div class="input-field col s6">
        <i class="material-icons prefix">email</i>
        <input id="email" name = "email" type="text" class="validate" data-length="7" required>
    ...
    <div class="row">
      <div class="input-field col s6">
        ...
        <input id="no_pos" name = "no_pos" type="text" class="validate" required>
        <label for="no_pos">No. of Positions</label>
    </div>
    <center>
              <div class='row'><div class="input-field col s6">
                <button type='submit' name='rec_update' class='col s12 btn btn-large waves-effect blue darken-4'>SIGN UP</button></div></form><form method="post" action='../includes/stu_logout.php'>
				</form>
            </center>
