     ...
     <header>
      ...
      <ul id="nav-mobile" class="side-nav fixed">
          ...
          <li class="no-padding">
            ...
            <li class="bold"><a href="print_list.php" class="collapsible-header  waves-effect waves-teal active">Print List</a>
            </li>
    ...
    <div class="col s12 m9 l10">
      ...
      <div id="home" class="section scrollspy">
		...
		<?php 
			...
			$sql = "select j_id from jobs where c_id='$c_id'";
...
<form method = "post" action = "download.php"><button type='submit' name="action" class='col s12 btn btn-large waves-effect blue darken-4' value="<?php   
                  echo $row['j_id'];?>"><?php   
                  echo $row['j_id'];?></button>
		</form>
    </li>
	<?php } ?>
